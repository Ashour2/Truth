        ...
        <div class="col-md-12">
         ...
         <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control" id="image" name="image" placeholder="Enter Name of Slider">
                </div>
            </div>
            </div>
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('sliders.index') }}" type="submit" class="btn btn-info">Go to Index</a>

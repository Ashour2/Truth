            ...
            @foreach ($articles as $article)
                ...
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('view.det' , $article->id) }}" class="btn btn-primary">Learn More</a>
                    </div>
                    {{-- <div class="card-footer">
...
<section class="gray-sec">
    <div class="container">
        ...
        <div align="center"><a class="btn btn-success" href="{{ route('view.all' , $category->id) }}">more news</a></div>
      @endforeach
    </div>
</section>
